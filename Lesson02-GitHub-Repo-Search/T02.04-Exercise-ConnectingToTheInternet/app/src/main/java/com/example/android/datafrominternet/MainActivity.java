...
public class MainActivity extends AppCompatActivity {
    ...
    private void makeGithubSearchQuery() {
        ...
        String githunSearchResults = null;
        try {
            githunSearchResults = NetworkUtils.getResponseFromHttpUrl(githubSearchUrl);
            mSearchResultsTextView.setText(githunSearchResults);
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
