...
public class MainActivity extends AppCompatActivity {
    ...
    public void addToWaitlist(View view) {
        ...
        if (mNewGuestNameEditText.getText().toString().trim().isEmpty() ||
                mNewPartySizeEditText.getText().toString().trim().isEmpty())
            return;
        ...
        try {
            ...
            Log.e(LOG_TAG, "Failed to parse party size text to number: " + nfe.getMessage());
        }
