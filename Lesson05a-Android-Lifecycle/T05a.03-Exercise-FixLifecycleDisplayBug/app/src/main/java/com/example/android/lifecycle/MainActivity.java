...
public class MainActivity extends AppCompatActivity {
    ...
    private final static ArrayList<String> mLifecycleCalbacks = new ArrayList<>();
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = mLifecycleCalbacks.size() - 1; i >= 0; i --) {
            mLifecycleDisplay.append(mLifecycleCalbacks.get(i) + "\n");
        }
        // COMPLETED (5) Clear mLifecycleCallbacks after iterating through it
        mLifecycleCalbacks.clear();
    ...
    protected void onStop() {
        ...
        mLifecycleCalbacks.add(0, ON_STOP);
    ...
    protected void onDestroy() {
        ...
        mLifecycleCalbacks.add(0, ON_DESTROY);
